...
export default function WordCounter() {
    ...
    try {
      if (navigator.share) {
        await navigator.share({
          title: "ToolsGift Word Counter",
          text: "Check out this shared Word Counter result.",
          url: share.shareUrl,
        });
  ...
  const stats = [
    ...
    { label: "Characters without spaces", value: charactersWithoutSpaces },
    { label: "Sentences", value: sentences },
    { label: "Paragraphs", value: paragraphs },
    { label: "Lines", value: lines },
    {
      label: "Reading time",
      value: readingTime ? `${readingTime} min` : "0 min",
    },
  ];
  return (
    <div className="space-y-8">
      <section className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-400">
            Count words, characters, sentences, paragraphs and more instantly.
          </p>
        </div>
        <textarea
          value={text}
          ...
          aria-label="Text for word counting"
        />
      ...
      <section className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
        ...
        <p className="mt-3 leading-7 text-gray-600 dark:text-gray-400">
          ToolsGift Word Counter is a free online tool for counting words and
          characters in essays, articles, social media posts, assignments,
          documents and other text. It also provides sentence, paragraph and
      ...
      <section className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
        ...
        <div className="mt-5 space-y-5">
          <div>
            ...
            <p className="mt-2 text-gray-600 dark:text-gray-400">
              Paste or type your text into the Word Counter and the word count
          ...
          <div>
            <h3 className="font-semibold text-gray-900 dark:text-white">
              Can I copy, download or share my text?
            </h3>
            <p className="mt-2 text-gray-600 dark:text-gray-400">
              Yes. You can copy the text to your clipboard, download it as a
              TXT file, or generate a share link that can be shared with
              others.
            </p>
          </div>
        </div>
