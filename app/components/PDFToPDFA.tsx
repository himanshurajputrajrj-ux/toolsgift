...
export default function PDFToPDFA() {
  ...
  const convertToPDFA = async () => {
    ...
    try {
       ...
       */
      outputPDF.setTitle(
        file.name.replace(/\.pdf$/i, "") || "ToolsGift PDF Archive"
      );

      outputPDF.setAuthor("ToolsGift");

      outputPDF.setSubject(
        "Archival PDF document generated by ToolsGift"
      );

      outputPDF.setCreator("ToolsGift PDF to PDF/A");
